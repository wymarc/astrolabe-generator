...
public class HelpDialog extends JDialog {
    ...
    private JPanel getTextPanel(){
        ...
        String text = "This program will generate a set of PostScript files for<br/>";
        text +=       "printing or other use. You will need to know your current<br/>";
        text +=       "location in degrees, minutes and seconds (454545N 1232323E<br/>";
        text +=       "for example).<br/><br/>";
        text +=       "See Help, Astrolabe Resources for links to software for<br/>";
        text +=       "displaying and printing.";
